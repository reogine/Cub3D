...
/*   Updated: 2023/03/04 10:06:41 by midfath          ###   ########.fr       */
/*                                                                           */
/* ************************************************************************** */
...
void  mini_map_display(t_window *win)
{
  ...
  while (win->map[cordo.y]  && cordo.y < \
      (int)(win->ply.y / TILESIZE) + 10) 
  {
    if ((int)(win->ply.x / TILESIZE) < 5)
      cordo.x = 0; 
    else
      cordo.x = ((int)(win->ply.x / TILESIZE) - 5);
    while (win->map[cordo.y][cordo.x]   && cordo.x < \
